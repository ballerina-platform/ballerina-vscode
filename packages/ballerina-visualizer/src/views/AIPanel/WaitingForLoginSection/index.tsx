        ...
        return (
            <Container>
                <AlertContainer variant="primary">
                    ...
                    <SubTitle>
                        Enter your Anthropic API key to connect to WSO2 Agent Builder. Your API key will be securely stored
        ...
        return (
            <Container>
                <AlertContainer variant="primary">
                    ...
                    <SubTitle>
                        Enter your AWS credentials to connect to WSO2 Agent Builder via AWS Bedrock. Your credentials will be securely stored
                        and used for authentication.
                    </SubTitle>
        ...
        return (
            <Container>
                <AlertContainer variant="primary">
                    ...
                    <SubTitle>
                        Select the GCP service account JSON key file to authenticate WSO2 Agent Builder with Google Vertex AI.
    ...
    return (
        <Container>
            <AlertBox
                ...
                onClick={cancelLogin}
                subTitle={
                    "Waiting for the login credentials. Please sign in to your WSO2 Agent Builder account in the browser window to continue."
                }
