...
The AI Copilot Generation feature in WSO2 Integrator: BI allows users to generate Ballerina code using AI assistance. Users can generate code from natural language descriptions, create hello world examples, and transform existing code (e.g., change to HTTP service). The generation feature is accessible from the Design section via the "Generate" button and requires users to be logged in to WSO2 Agent Builder (either via BI Intel or BYOK).
...
**Steps:**
1. Ensure user is logged in to WSO2 Agent Builder (BI Intel or BYOK)
...
**Steps:**
1. Ensure user is logged in to WSO2 Agent Builder
