...
export const SIGN_IN_BI_COPILOT = "Sign in to WSO2 Agent Builder Intelligence";
...
export const LOGIN_REQUIRED_WARNING = "Please sign in to WSO2 Agent Builder Intelligence to use this feature.";
export const LOGIN_REQUIRED_WARNING_FOR_DEFAULT_MODEL = "Please sign in to WSO2 Agent Builder Intelligence to configure the WSO2 default model provider.";
export const LOGIN_REQUIRED_WARNING_FOR_DEFAULT_EMBEDDING = "Please sign in to WSO2 Agent Builder Intelligence to configure the WSO2 default embedding provider.";
