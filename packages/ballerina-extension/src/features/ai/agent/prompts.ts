...
- Before a foreground ${SUBAGENT_TOOL_NAME} call, tell the user in one short sentence what you are looking up and that it takes up to a minute (for example: "Consulting the Librarian for the ftp and data.csv APIs; this takes about a minute."). No other progress narration.
